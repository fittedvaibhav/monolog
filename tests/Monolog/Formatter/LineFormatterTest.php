...
/**
 * @covers Fitted\Monolog\Formatter\LineFormatter
 */
class LineFormatterTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testDefFormatWithObject()
    {
        ...
        $this->assertEquals('['.date('Y-m-d').'] meh.ERROR: foobar [] {"foo":{"Fitted\\\\Monolog\\\\Formatter\\\\TestFoo":{"foo":"fooValue"}},"bar":{"Fitted\\\\Monolog\\\\Formatter\\\\TestBar":"bar"},"baz":[],"res":"[resource(stream)]"}'."\n", $message);
    }
