...
use Fitted\Monolog\Handler\TestHandler;

class LoggerTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @covers Fitted\Monolog\Logger::getName
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::getLevelName
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::withName
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::toMonologLevel
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::__construct
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::addRecord
     */
    public function testLog()
    {
        $logger = new Logger(__METHOD__);

        $handler = $this->prophesize('Fitted\Monolog\Handler\NullHandler');
    ...
    /**
     * @covers Fitted\Monolog\Logger::pushHandler
     * @covers Fitted\Monolog\Logger::popHandler
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::setHandlers
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::pushProcessor
     * @covers Fitted\Monolog\Logger::popProcessor
     */
    ...
    {
        $logger = new Logger(__METHOD__);
        $handler = $this->createMock('Fitted\Monolog\Handler\HandlerInterface');
        ...
        $processor = $this->getMockBuilder('Fitted\Monolog\Processor\WebProcessor')
    ...
    public function testHandlersNotCalledBeforeFirstHandling()
    {
        ...
        $handler1 = $this->createMock('Fitted\Monolog\Handler\HandlerInterface');
        ...
        $handler2 = $this->createMock('Fitted\Monolog\Handler\HandlerInterface');
        ...
        $handler3 = $this->createMock('Fitted\Monolog\Handler\HandlerInterface');
    ...
    /**
     * @covers Fitted\Monolog\Logger::isHandling
     */
     ...
     * @covers Fitted\Monolog\Logger::debug
     * @covers Fitted\Monolog\Logger::info
     * @covers Fitted\Monolog\Logger::notice
     * @covers Fitted\Monolog\Logger::warning
     * @covers Fitted\Monolog\Logger::error
     * @covers Fitted\Monolog\Logger::critical
     * @covers Fitted\Monolog\Logger::alert
     * @covers Fitted\Monolog\Logger::emergency
     */
     ...
     * @covers Fitted\Monolog\Logger::setTimezone
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::setTimezone
     * @covers Fitted\Monolog\DateTimeImmutable::__construct
     */
     ...
     * @covers Fitted\Monolog\Logger::useMicrosecondTimestamps
     * @covers Fitted\Monolog\Logger::addRecord
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::setExceptionHandler
     */
    ...
    /**
     * @covers Fitted\Monolog\Logger::handleException
     */
    public function testDefaultHandleException()
    {
        $logger = new Logger(__METHOD__);
        $handler = $this->getMockBuilder('Fitted\Monolog\Handler\HandlerInterface')->getMock();
        $handler->expects($this->any())
            ->method('isHandling')
            ->will($this->returnValue(true))
        ;
