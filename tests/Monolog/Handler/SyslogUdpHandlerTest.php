...
class SyslogUdpHandlerTest extends TestCase
{
    ...
    public function testWeSplitIntoLines()
    {
        ...
        $socket = $this->getMockBuilder('Fitted\Monolog\Handler\SyslogUdp\UdpSocket')
            ->onlyMethods(['write'])
    ...
    {
        return ['message' => $msg, 'level' => \Fitted\Monolog\Logger::WARNING, 'context' => null, 'extra' => [], 'channel' => 'lol', 'datetime' => new \DateTimeImmutable('2014-01-07 12:34:56')];
    }
}
