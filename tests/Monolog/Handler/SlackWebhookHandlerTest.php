...
use Fitted\Monolog\Handler\Slack\SlackRecord;

/**
 * @author Haralan Dobrev <hkdobrev@gmail.com>
 * @see    https://api.slack.com/incoming-webhooks
 * @coversDefaultClass Fitted\Monolog\Handler\SlackWebhookHandler
 */
class SlackWebhookHandlerTest extends TestCase
{
    ...
    public function testConstructorMinimal()
    {
        ...
        $this->assertInstanceOf('Fitted\Monolog\Handler\Slack\SlackRecord', $slackRecord);
    ...
    public function testGetFormatter()
    {
        ...
        $this->assertInstanceOf('Fitted\Monolog\Formatter\FormatterInterface', $formatter);
    }
