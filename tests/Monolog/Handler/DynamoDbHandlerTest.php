...
class DynamoDbHandlerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Fitted\Monolog\Handler\DynamoDbHandler', new DynamoDbHandler($this->client, 'foo'));
    }

    public function testInterface()
    {
        $this->assertInstanceOf('Fitted\Monolog\Handler\HandlerInterface', new DynamoDbHandler($this->client, 'foo'));
    }

    public function testGetFormatter()
    {
        $handler = new DynamoDbHandler($this->client, 'foo');
        $this->assertInstanceOf('Fitted\Monolog\Formatter\ScalarFormatter', $handler->getFormatter());
    }
