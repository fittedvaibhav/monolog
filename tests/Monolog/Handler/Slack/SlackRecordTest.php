...
namespace Fitted\Monolog\Handler\Slack;

use Fitted\Monolog\Logger;
use Fitted\Monolog\Test\TestCase;

/**
 * @coversDefaultClass Fitted\Monolog\Handler\Slack\SlackRecord
 */
class SlackRecordTest extends TestCase
{
    ...
    public function testTextEqualsFormatterOutput()
    {
        ...
        $formatter2 = $this->createMock('Fitted\Monolog\\Formatter\\FormatterInterface');
        $formatter2
            ->expects($this->any())
            ->method('format')
            ->will($this->returnCallback(function ($record) {
