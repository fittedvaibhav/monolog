...
class ProcessHandlerTest extends TestCase
{
    ...
    /**
     * @covers Fitted\Monolog\Handler\ProcessHandler::__construct
     * @covers Fitted\Monolog\Handler\ProcessHandler::guardAgainstInvalidCommand
     * @covers Fitted\Monolog\Handler\ProcessHandler::guardAgainstInvalidCwd
     * @covers Fitted\Monolog\Handler\ProcessHandler::write
     * @covers Fitted\Monolog\Handler\ProcessHandler::ensureProcessIsStarted
     * @covers Fitted\Monolog\Handler\ProcessHandler::startProcess
     * @covers Fitted\Monolog\Handler\ProcessHandler::handleStartupErrors
     */
    public function testWriteOpensProcessAndWritesToStdInOfProcess()
    {
        ...
        $mockBuilder = $this->getMockBuilder('Fitted\Monolog\Handler\ProcessHandler');
    ...
    public function testConstructWithValidCwdWorks()
    {
        ...
        $this->assertInstanceOf(
            'Fitted\Monolog\Handler\ProcessHandler',
            $handler,
    ...
    /**
     * @covers Fitted\Monolog\Handler\ProcessHandler::handleStartupErrors
     * @covers Fitted\Monolog\Handler\ProcessHandler::selectErrorStream
     */
    ...
    /**
     * @covers Fitted\Monolog\Handler\ProcessHandler::close
     */
    public function testCloseClosesProcess()
    {
        $class = new \ReflectionClass('Fitted\Monolog\Handler\ProcessHandler');
