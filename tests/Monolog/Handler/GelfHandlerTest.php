...
use Fitted\Monolog\Formatter\GelfMessageFormatter;
...
class GelfHandlerTest extends TestCase
{
    ...
    /**
     * @covers Fitted\Monolog\Handler\GelfHandler::__construct
     */
    public function testConstruct()
    {
        $handler = new GelfHandler($this->getMessagePublisher());
        $this->assertInstanceOf('Fitted\Monolog\Handler\GelfHandler', $handler);
    }
