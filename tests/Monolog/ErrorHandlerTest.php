...
class ErrorHandlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testHandleException()
    {
        ...
        $resHandler = $errHandler->registerExceptionHandler($map = ['Fitted\Monolog\CustomTestException' => LogLevel::DEBUG, 'TypeError' => LogLevel::NOTICE, 'Throwable' => LogLevel::WARNING], false);
        $this->assertSame($errHandler, $resHandler);
