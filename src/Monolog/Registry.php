 ...
 *
 * <code>
 * $application = new Fitted\Monolog\Logger('application');
 * $api = new Fitted\Monolog\Logger('api');
 *
 * Fitted\Monolog\Registry::addLogger($application);
 * Fitted\Monolog\Registry::addLogger($api);
 *
 * function testLogger()
 * {
 *     Fitted\Monolog\Registry::api()->error('Sent to $api Logger instance');
 *     Fitted\Monolog\Registry::application()->error('Sent to $application Logger instance');
 * }
 * </code>
 *
